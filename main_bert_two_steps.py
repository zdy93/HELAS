...
def main():
    ...
    parser.add_argument('--performance_file', default='all_two_steps_performance.txt')
    ...
    for epoch in range(args.n_epochs):
        ...
        if args.annotator in ['human', 'human_intersection']:
            ...
            train_batch_noham_generator = great_batch_generator(X_train_ham, y_train_ham, None,
                                                                masks_train_ham,
                                                                ham_batch_size)
            train_classification_loss_ham, train_acc, train_f1 = train_no_ham(model, optimizer_classification,
                                                                              criterion,
